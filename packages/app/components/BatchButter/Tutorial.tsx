...
function text(step: number): string {
  switch (step) {
    ...
    case 2:
      return "Your deposits will be held in Butter’s batch processing queue. Note: To minimise gas fees, deposits are processed approximately every 24-48 hours. You are able to withdraw your deposits during this phase.";
    case 3:
    ...
    <>
      ...
      >
        ...
        <div className="w-full justify-center h-full md:w-8/12 pt-2 flex flex-col">
          <div className="md:h-1/2">{tutorialContent(step)}</div>
