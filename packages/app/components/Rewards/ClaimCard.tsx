...
const ClaimCard: React.FC<ClaimCardProps> = ({
  ...
  return (
    <div
      className={`hover:scale-102 transition duration-500 ease-in-out transform w-full md:h-48 border-b border-customLightGray ${pool === undefined || claimAmount.eq(constants.Zero) ? "hidden" : ""}`}
    >
