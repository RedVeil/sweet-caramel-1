    ...
    <div>
      <div className="flex">
        <input
          ...
          className="ml-1 mr-4 focus:ring-blue-500 h-4 w-4 text-blue-600 border-gray-300 rounded"
        />
        <label className="text-left font-semibold text-gray-900 pb-2" htmlFor="acceptTerms">
