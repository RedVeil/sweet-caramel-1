            ...
            <div className="">
              ...
              <div className="flex flex-row flex-wrap items-center mt-4 justify-center md:justify-start">
                ...
                <div className="px-6 xs:border-r-2 border-gray-200 mt-2">
                  <StatusWithLabel
                    content={stakingPageInfo?.poolInfo ? formatStakedAmount(stakingPageInfo?.poolInfo.totalStake) : "0"}
                    label="Total Staked"
                  />
                </div>
          ...
          <div className="mb-8 md:mb-0 md:w-1/3 flex flex-col md:pr-8">
            {(loading && (
              ...
              <div className="pt-4 h-full px-6 border border-gray-200 rounded-3xl shadow-custom mb-10">
                <div className="pt-2">
                  <TabSelector activeTab={withdraw} setActiveTab={setWithdraw} labels={["Stake", "Unstake"]} />
                </div>
                      ...
                      {stakingPageInfo?.stakedToken?.symbol === "POP" && withdraw ? (
                        ...
                        <div className="mt-10 mb-9">
                          <TokenInput
                            ...
                            balance={
                              withdraw
                                ? stakingPageInfo?.balances?.staked || constants.Zero
                                : stakingPageInfo?.balances?.wallet || constants.Zero
                            }
