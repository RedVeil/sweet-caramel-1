...
contract MultiRewardsStakingTest is Test {
  ...
  function test__accrual_multiple_rewardsToken() public {
    ...
    (, , , uint224 indexReward1, uint32 lastUpdatedTimestampReward1) = staking.rewardsInfos(iRewardsToken1);
    ...
    (, , , indexReward1, lastUpdatedTimestampReward1) = staking.rewardsInfos(iRewardsToken1);
    ...
    (, , , uint224 indexReward2, uint32 lastUpdatedTimestampReward2) = staking.rewardsInfos(iRewardsToken2);
    ...
    (, , , indexReward2, lastUpdatedTimestampReward2) = staking.rewardsInfos(iRewardsToken2);
  ...
  function test__accrual_on_transfer() public {
    ...
    assertEq(staking.rewardsAccrued(address(this), iRewardsToken1), 0 ether);
  ...
  function test__accrual_with_user_joining_later() public {
    ...
    assertEq(staking.userIndex(alice, iRewardsToken1), index);
    assertEq(staking.rewardsAccrued(alice, iRewardsToken1), 3333333333333333333);
  ...
  function _addRewardsTokenWithEscrow(MockERC20 rewardsToken) internal {
    ...
    staking.addRewardsToken(IERC20(address(rewardsToken)), 0.1 ether, 10 ether, true, 100, 10000000, 0);
  }
  ...
  function test__addRewardsToken() public {
    ...
    emit RewardsInfoUpdate(iRewardsToken1, 0.1 ether, (callTimestamp + 100).safeCastTo32());
    ...
    (bool useEscrow, uint224 escrowDuration, uint24 escrowPercentage, uint256 offset) = staking.escrowInfos(
      iRewardsToken1
    );
  ...
  function test__addRewardsToken_end_time_not_affected_by_other_transfers() public {
    ...
    uint256 callTimestamp = block.timestamp;
    staking.addRewardsToken(iRewardsToken1, 0.1 ether, 10 ether, true, 100, 10000000, 0);
  ...
  function testFail__addRewardsToken_token_exists() public {
    ...
    vm.expectRevert(MultiRewardsStaking.RewardTokenAlreadyExist.selector);
    staking.addRewardsToken(iRewardsToken1, 0.1 ether, 10 ether, true, 100, 10000000, 0);
  }
  ...
  function test__fundReward() public {
    ...
    vm.expectEmit(false, false, false, true, address(staking));
    emit RewardsInfoUpdate(iRewardsToken1, 0.1 ether, oldRewardsEndTimestamp + 100);
