...
contract PropertyTest is EnhancedTest {
  ...
  function prop_withdraw(
    ...
    uint256 oldReceiverAsset = IERC20(_asset_).balanceOf(receiver);
    ...
    uint256 newReceiverAsset = IERC20(_asset_).balanceOf(receiver);
  ...
  function prop_redeem(
    ...
    vm.prank(caller);
    uint256 assets = IERC4626(_asset_).redeem(shares, receiver, owner);
