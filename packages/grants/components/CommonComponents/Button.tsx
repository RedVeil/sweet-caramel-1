  ...
  const buttonVariant = () => {
    switch (variant) {
      ...
      case "secondary":
        if (disabled)
          return "bg-customLightGray border-customLightGray text-secondaryLight hover:border-customLightGray hover:bg-customLightGray hover:text-secondaryLight";
        return "px-8 py-3 font-medium bg-transparent border border-primary text-primary hover:bg-primary hover:border-primary hover:text-white active:bg-white active:border-primary active:text-primary";
      case "tertiary":
