    ...
    <div className="w-9/12 mx-auto">
      {election && "registration" == election.electionStateStringShort && (
        <>
          <figure className="bg-white rounded-xl p-6 mb-4">
            <div className="space-y-4">
              <blockquote>
                ...
                <p className="text-md">This grant is currently open for registration. </p>
              </blockquote>
              <figcaption className="text-sm">
                <div>To register, interested organizations must be approved by token holders.</div>
              </figcaption>
            </div>
          </figure>
          ...
          <span className={`flex flex-row items-center pt-8 ${alreadyRegistered ? "" : "hidden"}`}>
            <p className="text-lg text-black-700 font-bold gray-color">You are registered for this election</p>
          ...
          <div className="space-y-4">
            <blockquote>
              <p className="text-lg font-semibold pb-2">
                <img src="/images/popcorn_v1_light_bg.png" width="30" className="inline-block" /> +{" "}
                <img className="h-12 inline-block" src="/images/partners/chainlink.svg" alt="Chainlink" width="85" />{" "}
              </p>
              <p className="text-md">This grant election is {election.electionStateStringShort}. </p>
            </blockquote>
            <figcaption className="text-sm">
              <div>Sit tight, winners will be announced soon using your votes and Chainlink VRF!</div>
            </figcaption>{" "}
          </div>
        </figure>
      )}
      {election && ["finalized"].includes(election.electionStateStringShort) && (
        <figure className="bg-white rounded-xl p-6 mb-8">
          <div className="space-y-4">
            ...
            <figcaption className="text-sm">
              <div>
                The winners have been awarded using your votes and Chainlink VRF.
                <p>
                  <img src="/images/popcorn_v1_light_bg.png" width="30" className="inline-block" /> +{" "}
                  <img className="h-12 inline-block" src="/images/partners/chainlink.svg" alt="Chainlink" width="85" />{" "}
                </p>
