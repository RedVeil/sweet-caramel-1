  ...
  return (
    <div className="fixed z-10 inset-0 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
      <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div className="inline-block align-bottom bg-white rounded-4xl px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-sm sm:w-full sm:p-8">
          <div>
            {icon ? (
            ...
            <div className="mt-3 text-center sm:mt-5">
              ...
              <div className="mt-2">
                <p className="text-base text-gray-500 text-center">{content}</p>
              </div>
            </div>
          </div>
          <div className="mt-5 sm:mt-6 sm:grid sm:grid-cols-2 sm:gap-3 sm:grid-flow-row-dense">
            ...
            {onDismiss && (
              <Button variant="secondary" onClick={() => dismiss()} className="py-2 px-5 w-full">
                {onDismiss.label}
              </Button>
            )}
          </div>
