                ...
                <div className="inline-block align-bottom bg-white rounded-4xl px-5 pt-4 md:pt-6 pb-5 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-md sm:w-full sm:p-8">
                  ...
                  <div className="mt-6 md:mt-8">
                    <div>
                      {onChangeNetwork && (
                        <>
                          <Button variant="primary" onClick={changeNetwork} className="py-3 px-5">
                            {onChangeNetwork.label}
                          </Button>
                        </>
                      )}
                      {onChangeUrl && (
                        <div className="w-full">
                          ...
                          <Button variant="secondary" onClick={changeUrl} className="py-3 px-5">
                            {onChangeUrl.label}
                          </Button>
                        </div>
                      )}
                      {onDisconnect && (
                        <div className="w-full">
                          ...
                          <Button variant="secondary" onClick={disconnect} className="py-3 px-5">
                            {onDisconnect.label}
                          </Button>
                        </div>
                      )}
