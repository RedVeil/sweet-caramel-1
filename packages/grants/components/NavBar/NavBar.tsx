    ...
    <>
      <nav className="flex shadow-md py-3 px-14 bg-white">
        ...
        <ul className="flex flex-row items-center mx-auto space-x-16">
          ...
          <li>
            <NavbarLink label="White Paper" url="/docs/Popcorn_whitepaper_v1.pdf" isActive={false} target="_window" />
          </li>
          <li>
            <NavbarLink label="Beneficiaries" url="/beneficiaries" isActive={router.pathname === "/beneficiaries"} />
          </li>
          <li>
            <NavbarLink
              label="Proposals"
            ...
            />
            <ProposalsMenu visible={showProposals} toggleSubMenu={() => setShowProposals(!showProposals)} />
          </li>
        </ul>
        <button
        ...
        >
          ...
          {account && <div className="w-2 h-2 bg-green-400 rounded-full ml-2" />}
        </button>
      </nav>
    </>
  );
