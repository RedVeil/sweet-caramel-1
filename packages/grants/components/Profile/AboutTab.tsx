  ...
  return (
    <>
      ...
      <div className={classnames("flex flex-col", {
        ...
        <div className={classnames("flex-grow w-full flex-shrink-0 mb-3", {
        ...
        {links?.website && (
          <div className={classnames("flex-grow w-full flex-shrink-0 mt-3 lg:mt-0", {
      ...
      <div className={classnames("flex flex-col", {
        ...
        <div className={classnames("flex-grow w-full flex-shrink-0 mt-3", {
          'lg:w-1/2': isBeneficiaryPage
        })}>
          <div className="p-4 border border-customLightGray rounded-lg min-h-[100px] flex flex-col justify-center">
