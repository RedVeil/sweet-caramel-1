...
const BeneficiaryAddress: React.FC<FormStepProps> = ({ form, navigation, visible }) => {
  ...
  return (
    visible && (
      <div className="mx-auto content-center justify-items-center">
        ...
        />
        {web3.utils.isAddress(formData?.beneficiaryAddress) && <ContinueButton navigation={navigation} />}
      </div>
    )
  );
};
