      ...
      name: (
        <div>
          ...
          <InfoIconWithModal title="What's a wallet?">
            <div>
              A crypto wallet is a piece of software that is able to transact with blockchains. Wallets let holders
              store and trade various cryptocurrencies and tokens. The most common ways to connect wallets are through
              browser extensions such as{" "}
              <a href="https://metamask.io/" target="_window" className="text-blue-500">
                MetaMask
              </a>{" "}
      ...
      <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
        <div className="sm:text-center lg:text-left">
          ...
          <p className="mt-2 text-lg text-gray-500">
            The following application is for educational, environmental and open source projects seeking funding.
            <InfoIconWithModal
              title="About Funding"
            ...
            <div className="lg:mx-auto lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-2 lg:grid-flow-col-dense lg:gap-24">
              <div className="px-4 max-w-xl mx-auto sm:px-6 lg:py-32 lg:max-w-none lg:mx-0 lg:px-0 lg:col-start-2">
                <div>
                  ...
                  <div className="mt-6">
                    <h2 className="text-3xl font-extrabold tracking-tight text-gray-900">Grants are right this way</h2>
                    <p className="mt-4 text-lg text-gray-500">
                      After the application has been submitted, it will be subject to a round of voting. If it receives
                      more "Yes" votes than "No" votes, the organization will be eligible to receive grants.
                    </p>
                  </div>
                </div>
              </div>
