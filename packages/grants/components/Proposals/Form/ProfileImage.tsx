...
const ProfileImage: React.FC<FormStepProps> = ({ form, navigation, visible }) => {
    ...
    visible && (
      <>
        <IpfsUpload
          ...
          fileInstructions={"Image should be square (ideally 150px x 150px) and less than 5mb"}
          fileType={"image/*"}
          numMaxFiles={1}
          maxFileSizeMB={5}
        />
        ...
        {formData?.files?.profileImage?.image !== "" && formData?.files?.profileImage?.description !== "" && (
