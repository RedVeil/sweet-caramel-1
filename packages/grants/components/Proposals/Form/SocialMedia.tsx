...
const SocialMedia: React.FC<FormStepProps> = ({ form, navigation, visible }) => {
    ...
    visible && (
      <div className="mx-auto content-center justify-items-center">
        ...
        <div className="grid justify-items-stretch ...">
          <p className="mt-8 mb-6 block text-sm font-medium text-gray-700">Add links to your social media profiles.</p>
            ...
            <div className="col-span-6 sm:col-span-3">
              <div>
                ...
                <select
                  ...
                  value={platform}
                >
                  {["Facebook", "LinkedIn", "Instagram", "GitHub", "Twitter"].map((platform, i) => (
