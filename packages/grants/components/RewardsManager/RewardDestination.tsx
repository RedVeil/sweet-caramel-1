...
export default function RewardDestination({ destination, reward }: RewardDestinationProps): JSX.Element {
  return (
    <div>
      ...
      <span className="flex flex-row items-center justify-end mt-1">
        ...
        <img src="/images/popcorn_v1_rainbow_bg.png" alt="Logo" className="w-4 h-4 ml-2"></img>
      </span>
    </div>
  );
}
