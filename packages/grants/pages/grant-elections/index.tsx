      ...
      <div className="bg-gray-900">
        <div className="pt-12 px-4 sm:px-6 lg:px-8 lg:pt-20">
          <div className="text-center">
            ...
            <p className="mt-2 text-3xl font-extrabold text-white sm:text-4xl lg:text-5xl">DeFi for the People.</p>
                      ...
                      <div className="flex-1 flex flex-col justify-between border-t-2 border-gray-100 p-6 bg-gray-50 sm:p-10 lg:p-6 xl:p-10">
                        <ul className="space-y-4">
                          ...
                          <li className="flex items-start">
                            <div className="flex-shrink-0">
                              {(elections[0] &&
                                ["closed", "finalized"].includes(elections[0]?.electionStateStringShort) && (
                    ...
                    <div className="border-t-2 border-gray-100 rounded-b-lg pt-10 pb-8 px-6 bg-gray-50 sm:px-10 sm:py-10">
                      <ul className="space-y-4">
                        ...
                        <li className="flex items-start">
                          <div className="flex-shrink-0">
                            {(elections[2] &&
                              ["closed", "finalized"].includes(elections[2]?.electionStateStringShort) && (
                                <XIcon className="flex-shrink-0 h-6 w-6 text-red-500" />
                              )) || <CheckIcon className="flex-shrink-0 h-6 w-6 text-green-500" />}
                          </div>
                          <p className="ml-3 text-base font-medium text-gray-500 leading-[140%]">
                      ...
                      <div className="flex-1 flex flex-col justify-between border-t-2 border-gray-100 p-6 bg-gray-50 sm:p-10 lg:p-6 xl:p-10">
                        <ul className="space-y-4">
                          ...
                          <li className="flex items-start">
                            <div className="flex-shrink-0">
                              {(elections[1] &&
                                ["closed", "finalized"].includes(elections[1]?.electionStateStringShort) && (
                                  <XIcon className="flex-shrink-0 h-6 w-6 text-red-500" />
                                )) || <CheckIcon className="flex-shrink-0 h-6 w-6 text-green-500" />}
                            </div>
                            <p className="ml-3 text-base font-medium text-gray-500">
                              Election is {elections && elections[1]?.electionStateStringLong}.
                            </p>
                          </li>
