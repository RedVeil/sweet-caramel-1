...
export default function Register(): JSX.Element {
  ...
  async function checkRegistrationAllowance(): Promise<void> {
    setRegistrationAllowance(
      await Promise.all(
        [0, 1, 2].map(
          async (term) =>
            (await contracts.beneficiaryRegistry.beneficiaryExists(account)) &&
  ...
  useEffect(() => {
    if (account && contracts?.beneficiaryRegistry) {
                        ...
                        <div className="bg-white px-6 py-10">
                          <div>
                            ...
                            <div className="mt-4 flex items-center justify-center">
                              ...
                              <span className="text-xl font-medium text-gray-500">(est.)</span>
                            </div>
                          </div>
                        </div>
                        <div className="flex-1 flex flex-col justify-between border-t-2 border-gray-100 p-6 bg-gray-50 sm:p-10 lg:p-6 xl:p-10">
                          <div className="flex  flex-shrink-0 items-start">
                            {elections[0].electionState === 0 ? <Icon type="check" /> : <Icon type="x" />}
                            <p className="ml-3 text-base font-medium text-gray-500">
                              Registration {elections[0].electionState === 0 ? "Open" : "Closed"}
                            </p>
                          </div>
                          <div className="mt-4">
                            <div className="rounded-lg shadow-md">
                              <button
                                ...
                                disabled={elections[0].electionState > 0 || !allowedToRegister[0] || wait}
                              >
                      ...
                      <div className="bg-white rounded-t-lg px-6 pt-12 pb-10">
                        <div>
                          ...
                          <div className="mt-4 flex items-center justify-center">
                            ...
                            <span className="text-2xl font-medium text-gray-500">(est.)</span>
                          </div>
                        </div>
                      </div>
                      <div className="border-t-2 border-gray-100 rounded-b-lg pt-10 pb-8 px-6 bg-gray-50 sm:px-10 sm:py-10">
                        <div className="flex  flex-shrink-0 items-start">
                          {elections[2].electionState === 0 ? <Icon type="check" /> : <Icon type="x" />}
                          <p className="ml-3 text-base font-medium text-gray-500">
                            Registration {elections[2].electionState === 0 ? "Open" : "Closed"}
                          </p>
                        </div>
                        <div className="mt-6">
                          <div className="rounded-lg shadow-md">
                            {account ? (
                              <button
                                ...
                                disabled={elections[2].electionState !== 0 || !allowedToRegister[2] || wait}
                  ...
                  <div className="mt-10 mx-auto max-w-md lg:m-0 lg:max-w-none lg:col-start-6 lg:col-end-8 lg:row-start-2 lg:row-end-3">
                    <div className="h-full flex flex-col rounded-lg shadow-lg overflow-hidden lg:rounded-none lg:rounded-r-lg">
                      <div className="flex-1 flex flex-col">
                        ...
                        <div className="flex-1 flex flex-col justify-between border-t-2 border-gray-100 p-6 bg-gray-50 sm:p-10 lg:p-6 xl:p-10">
                          <div className="flex  flex-shrink-0 items-start">
                            {elections[1].electionState === 0 ? <Icon type="check" /> : <Icon type="x" />}
                            <p className="ml-3 text-base font-medium text-gray-500">
                              Registration {elections[1].electionState === 0 ? "Open" : "Closed"}
                            </p>
                          </div>
                          <div className="mt-4">
                            <div className="rounded-lg shadow-md">
                              <button
                                ...
                                disabled={elections[1].electionState > 0 || !allowedToRegister[1] || wait}
                              >
                                Register for Election
                              </button>
                            </div>
