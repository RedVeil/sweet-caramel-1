...
const IndexPage = () => {
  ...
  return (
    <div className="w-full h-screen flex flex-col justify-center font-landing" style={{ backgroundColor: "#F8F8FB" }}>
      <FacebookPixel />
      <div className="hidden xl:flex flex-row w-full h-5/6">
        <div className="w-1/2 h-full">
          <div className="flex flex-col justify-between ml-24 md:w-8/12 2xl:mx-auto xl:w-1/2 h-full">
            <Link href="/" passHref>
              <a>
                <img src="/images/popcorn_v1_rainbow_bg.png" alt="Logo" className="rounded-full h-14 w-14"></img>
              </a>
            </Link>
            <div className="text-left">
              <p className="uppercase text-2xl font-medium text-gray-400">Coming Soon</p>
              <h1 className="uppercase font-bold text-8xl text-gray-900">Popcorn</h1>
            ...
            <footer className="pr-3">
              <Link href="https://etherscan.io/token/0xd0cd466b34a24fcb2f87676278af2005ca8a78c4" passHref>
                <a className="text-base text-gray-900 font-light md:border-b border-black w-max" target="_window">
                  Popcorn (POP) Token
                </a>
              </Link>
            </footer>
      ...
      <div className="flex xl:hidden flex-col w-full h-full pt-12 md:pt-18">
        ...
        <div className="w-full h-1/2 flex flex-row justify-end">
          <div className="flex flex-col justify-between w-11/12 h-5/6 my-auto">
            <div className="text-left">
              <p className="uppercase text-xl md:text-2xl font-medium text-gray-400">Coming Soon</p>
              <h1 className="uppercase font-bold text-6xl md:text-8xl text-gray-900">Popcorn</h1>
              <p className="text-2xl md:text-3xl text-gray-900">DeFi for the People</p>
              <form
                action="https://network.us1.list-manage.com/subscribe/post?u=5ce5e82d673fd2cfaf12849a5&amp;id=e85a091ed3"
                method="post"
                id="mc-embedded-subscribe-form"
