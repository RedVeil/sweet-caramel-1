...
export default function LockPop() {
  ...
  const getLockedPop = async () => {
    ...
    setLockedPop(Number(utils.formatEther(await contracts.staking.balanceOf(account))));
  };
      ...
      <div className="bg-gray-900">
        <div className="pt-12 px-4 sm:px-6 lg:px-8 lg:pt-20">
          <div className="text-center">
            ...
            <p className="mt-2 text-3xl font-extrabold text-white sm:text-4xl lg:text-5xl">POP Staking</p>
            <p className="mt-3 max-w-4xl mx-auto text-xl text-gray-300 sm:mt-5 sm:text-2xl">
              In order to participate in the selection of beneficiaries and awarding grants to beneficiaries, you need
              voice credits. Stake your POP to gain voice credits.
            </p>
          </div>
        </div>
                    ...
                    <div className="relative z-10 rounded-lg shadow-xl">
                      <div className="border-t-2 rounded-t-lg border-gray-100 rounded-b-lg  bg-gray-100  sm:px-10 sm:py-1">
                        <span className="flex flex-row items-center justify-between">
                          <h3 className="text-center text-xl font-extralight text-gray-900 sm:-mx-6" id="tier-growth">
                            Your Locked POP
                          </h3>
                ...
                <div className="mt-10 max-w-lg mx-auto lg:mt-0 lg:max-w-none lg:mx-0 lg:col-start-3 lg:col-end-6 lg:row-start-1 lg:row-end-4">
                  <div className="relative z-10 rounded-lg shadow-xl">
                    ...
                    <div className="border-t-2 border-gray-100 rounded-b-lg pt-10 pb-8 px-6 bg-gray-50 space-y-4 sm:px-10 sm:py-10">
                      <span className="flex flex-row items-center justify-between">
                        <p className="">For how long do you want to lock your POP?</p>
                        <DropdownSelect
                          label={"Time Period"}
                          selectedValue={
                            lockPeriods.find((period) => Number(period.value) === Number(lockDuration)).label
                          }
                      ...
                      <p className="text-sm text-gray-500">
                        Locking tokens for a longer period of time will give you more voting power. (POP * duration /
                        max duration)
                      </p>
