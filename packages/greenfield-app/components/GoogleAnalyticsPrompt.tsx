...
const GoogleAnalyticsPrompt = () => {
  ...
  return (
    <Transition show={openAnalyticsPrompt}>
      ...
      >
        <div className="bg-white w-full py-6 px-8 rounded-t-4xl md:rounded-t-lg shadow-custom flex flex-col md:flex-row items-center justify-center space-y-6 md:space-y-0 md:space-x-10 fixed bottom-0 left-0 z-40">
