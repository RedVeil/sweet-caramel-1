 ...
 * @dev deployVaultStaking can only be called by VaultsV1Controller
 */
contract VaultStakingFactory is Owned {
   ...
   */
  function deployVaultStaking(address vault) external onlyOwner returns (address stakingAddress) {
