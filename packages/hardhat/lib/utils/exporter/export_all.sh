...
$EXPORTER combine --inputs $OUT_DIR/hardhat-merge.json,$OUT_DIR/polygon-merge.json,$OUT_DIR/arbitrum-merge.json,$OUT_DIR/mainnet-merge.json,$OUT_DIR/bsc-merge.json,$OUT_DIR/rinkeby-merge.json,$OUT_DIR/optimism-merge.json --out $OUT_DIR/deployments.json
