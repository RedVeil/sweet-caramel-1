...
const AsSeenSection = () => {
	...
	return (
		<section className=" mt-10">
			<div className="px-6 lg:px-0">
				...
				<SliderContainer>
					<img src="/images/As_seen_in/ee.svg" alt="" className="px-2 md:px-5 w-10 h-10 object-contain" />
					<img src="/images/As_seen_in/utoday.svg" alt="" className="px-2 md:px-5 w-10 h-10 object-contain" />
					<img src="/images/As_seen_in/Finance Magnates.svg" alt="" className="px-2 md:px-5 w-10 h-10 object-contain" />
					<img src="/images/As_seen_in/bitcoinist.png" alt="" className="px-2 md:px-5 w-10 h-10 object-contain" />
					<img src="/images/As_seen_in/newsbtc.svg" alt="" className="px-2 md:px-5 w-10 h-10 object-contain" />
					<img src="/images/As_seen_in/cryptopotato.svg" alt="" className="px-2 md:px-5 w-10 h-10 object-contain" />
					<img src="/images/As_seen_in/digital.png" alt="" className="px-2 md:px-5 w-10 h-10 object-contain" />
				</SliderContainer>
			</div>
			<div className="hidden md:grid grid-cols-3 gap-8 xl:gap-14 mt-9 px-6 lg:px-0">
				<div className="col-span-3 md:col-span-1 cursor-default">
				<Lottie 
	...
	<div className=' pt-16 px-6 lg:px-0 order-2'>
		<h6 className=" font-medium leading-8 mb-3">Built With</h6>
			...
			{/* Carousel for Mobile */}
			<div className="md:hidden mt-11 order-1">
				<MobileCardSlider>
					<div className="px-6">
					<Lottie 
	    options={depositOptions}
