      ...
      <div className="col-span-12 lg:col-span-3 pt-10 hidden smmd:block">
        <div>
          ...
          <p className="mt-4 text-primaryDark">
            Core smart contracts have been reviewed by several security researchers and organizations.
          </p>
        </div>
      </div>
      <div className="col-span-12 lg:col-span-9 hidden smmd:grid grid-cols-3 gap-8 xl:gap-14 mt-20">
        ...
        <div className="col-span-3 smmd:col-span-1">
          ...
          <p className="text-primaryDark leading-5">
            ...
            Gnosis Safe and Nexus Mutual. <Link href="/docs/PopcornMay2022.pdf">See g0's review.</Link>
          </p>
        </div>
        <div className="col-span-3 smmd:col-span-1">
          ...
          <p className="text-primaryDark leading-5">
            ...
            <Link href="https://immunefi.com/bounty/popcornnetwork/">See Popcorn's bug bounty program.</Link>
          </p>
        </div>
      </div>
