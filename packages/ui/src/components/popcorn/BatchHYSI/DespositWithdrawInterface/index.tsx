...
export const DespositWithdrawInterface: React.FC<DespositWithdrawInterfaceProps> = ({
  ...
  return (
    <div className="relative mt-12 lg:-mt-12 bg-white rounded-lg shadow px-5 pt-6 sm:px-6" style={{ minWidth: 300 }}>
      <div className="flex flex-row">
        <div className="w-full px-6 py-6">
          <DepositWithdrawToggle withdrawal={withdrawal} setwithdrawal={setwithdrawal} />
          <TokenInput
          ...
          <div className="w-full text-center mt-10">
            <button
              ...
              onClick={(e) => deposit(depositAmount, withdrawal ? BatchType.Redeem : BatchType.Mint)}
